...
export const INITIAL_ORDERS: Order[] = [
  {
    id: "ORD-001",
    customer: "John Doe",
    items: [{ name: "Royal Cheese Burger", quantity: 2, price: 22.75 }],
    total: 45.5,
    status: "pending",
  ...
  },
  {
    ...
    customer: "Jane Smith",
    items: [
      { name: "The Classics for 3", quantity: 1, price: 38.75 },
      { name: "Iced Drink", quantity: 2, price: 10.0 },
    ],
    total: 58.75,
    status: "confirmed",
  ...
  },
  {
    id: "ORD-003",
    customer: "Bob Wilson",
    items: [{ name: "Classic Burger with Fries", quantity: 3, price: 24.08 }],
    total: 72.25,
    status: "pending",
